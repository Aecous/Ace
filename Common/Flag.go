...
func Flag(Info *HostInfo) {
	...
	flag.IntVar(&ThreadNum, "t", 1000, GetText("flag_thread_num"))
	...
	// 速率控制参数
	// ═════════════════════════════════════════════════
	flag.Float64Var(&PingRate, "prate", 0.1, GetText("flag_ping_rate"))
	flag.Int64Var(&PingTimeout, "pt", 6, GetText("flag_ping_timeout"))
	flag.StringVar(&LocalInterface, "iface", "", GetText("flag_local_interface"))
	flag.StringVar(&RateScanMode, "rmode", "balanced", GetText("flag_rate_scan_mode"))
	flag.BoolVar(&EnableEnhancedPortScan, "portscan", false, GetText("flag_enhanced_port_scan"))
...
func FlagFromRemote(info *HostInfo, argString string) error {
	...
	fs.BoolVar(&EnableFingerprint, "fingerprint", true, GetText("flag_enable_fingerprint"))
	fs.BoolVar(&LocalMode, "local", false, GetText("flag_local_mode"))

	fs.Float64Var(&PingRate, "prate", 0.1, GetText("flag_ping_rate"))
	fs.Int64Var(&PingTimeout, "pt", 6, GetText("flag_ping_timeout"))
	fs.StringVar(&LocalInterface, "iface", "", GetText("flag_local_interface"))
	fs.StringVar(&RateScanMode, "rmode", "balanced", GetText("flag_rate_scan_mode"))
